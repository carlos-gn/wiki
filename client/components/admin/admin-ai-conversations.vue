<template lang='pug'>
  v-container(fluid, grid-list-lg)
    v-layout(row wrap)
      v-flex(xs12)
        .admin-header
          img.animated.fadeInUp(src='/_assets/svg/icon-web-design.svg', alt='Conversations', style='width: 80px;')
          .admin-header-title
            .headline.blue--text.text--darken-2.animated.fadeInLeft Conversations
            .subtitle-1.grey--text.animated.fadeInLeft.wait-p2s View conversations
          v-spacer
