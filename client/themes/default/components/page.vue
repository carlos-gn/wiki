<template lang="pug">
  v-app(v-scroll='upBtnScroll', :dark='$vuetify.theme.dark', :class='$vuetify.rtl ? `is-rtl` : `is-ltr`', :style='$vuetify.breakpoint.smAndDown ?  `padding: 0;` : `padding: 0 36px;`')
    ...
    v-navigation-drawer(
      ...
      :class='$vuetify.theme.dark ? `grey darken-4-d4` : `grey lighten-3`'
      dark
      app
      clipped
      ...
      vue-scroll(:ops='scrollStyle')
        nav-sidebar(:color='$vuetify.theme.dark ? `grey darken-4-d4` : `grey lighten-3`', :items='sidebarDecoded', :nav-mode='navMode')
